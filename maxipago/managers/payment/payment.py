...
class PaymentManager(ManagerTransaction):
    ...
    def bank_slip(self, **kwargs):
        fields = (
            ...
            ## juros, taxas
            ('interestRate_date', {'translated_name': 'transactionDetail/payType/boleto/interestRate/date', 'required': False}),
            ('interestRate_type', {'translated_name': 'transactionDetail/payType/boleto/interestRate/type', 'required': False}),
            ('interestRate_value', {'translated_name': 'transactionDetail/payType/boleto/interestRate/value', 'required': False}),
            ('interestRate_frequency', {'translated_name': 'transactionDetail/payType/boleto/interestRate/frequency', 'required': False}),
